...
public class BackVideoProvider extends ContentProvider {

	private BackVideoDbHelper backVideoDbHelper;
	...
	static {
		VIDEO_MATCHER.addURI("com.tchip.autorecord.db.BackVideoProvider",
				"videos", VIDEOS);
		VIDEO_MATCHER.addURI("com.tchip.autorecord.db.BackVideoProvider",
				"video/#", VIDEO);
		VIDEO_MATCHER.addURI("com.tchip.autorecord.db.BackVideoProvider",
	...
	public boolean onCreate() {
		this.backVideoDbHelper = new BackVideoDbHelper(getContext());
		return false;
	}
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		SQLiteDatabase db = backVideoDbHelper.getReadableDatabase();
